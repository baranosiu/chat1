# TODO
- [ ] Zrobić bezpieczne generowanie unikalnych desktyprorów plików dla FTP nez użycia UUID (na razie jest możliwość zdublowania!)
- [ ] Uprawnienia w FTP (pomyśleć kto może wrzucać pliki na kanał i kto je usuwać oraz zaimplementować weryfikację tej polityki)
